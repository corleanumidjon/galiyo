...
import "./AustralianClimate.scss";
export const AustralianClimate = () => {
    ...
    const data = {
        ...
        answers: [
            ...
            {
                id: "a2",
                title: "O’rtacha oylik harorat  + 24,+28°S oralig’ida o’zgarib turadi, ko’tarilgan sari harorat pasayadi, lekin yil bo’yi bir xilda bo’ladi",
                isImage: false,
                img: "",
                answer: "2",
                bgColor: "#686de0"
    ...
    return <>
        <section className="australian-climate">
            <div className="container">
                <h2 className="australian-climate-title">
                    Avstraliya iqlimi
                </h2>
